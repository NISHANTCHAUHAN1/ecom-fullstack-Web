                  ...
                  <div key={index}>
                    {order.cartItems.map((item, index) => {
                      ...
                      return (
                        <div
                          key={index}
                           className="mt-5 flex flex-col overflow-hidden rounded-xl border border-blue-gray-200 md:flex-row" >
                          <div  className="w-full border-r border-blue-gray-200 bg-blue-gray-100 md:max-w-xs">
                            {/* left  */}
                            <div className="p-8">
